...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verify_age: (...args_1) => {
        ...
        const birth_year_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verify_age',
                                     'argument 1 (as invoked from Typescript)',
                                     'age-gate.compact line 33 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(birth_year_0) === 'bigint' && birth_year_0 >= 0n && birth_year_0 <= 65535n)) {
          __compactRuntime.typeError('verify_age',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(birth_year_0),
      ...
      revoke_access: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`revoke_access: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revoke_access',
                                     'argument 1 (as invoked from Typescript)',
                                     'age-gate.compact line 43 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._revoke_access_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      ...
      revoke_access: this.circuits.revoke_access
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('revoke_access', new __compactRuntime.ContractOperation());
  ...
  _verify_age_0(context, partialProofData, birth_year_0) {
    __compactRuntime.assert(birth_year_0 >= 1900n,
                            'birth year must be 1900 or later');
    __compactRuntime.assert(birth_year_0 <= 2026n,
                            'birth year cannot be in the future');
    __compactRuntime.assert(birth_year_0 <= 2008n,
  ...
  _revoke_access_0(context, partialProofData) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
